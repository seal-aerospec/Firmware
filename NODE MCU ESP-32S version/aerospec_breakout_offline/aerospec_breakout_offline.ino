...
void setup() {
    ...
    */
    ...
    if (!SD.exists(OUTPUTFILE)) {
      char label[265];
      sprintf(label, "%10s,%10s,%10s,%10s,%10s,%10s,%10s,%10s,%10s,%10s,%10s,%10s,%10s,%10s,%10s,%10s,%10s,%10s,%10s,%10s",
      "Counter","Date","Time", "Battery","Dp>0.3","Dp>0.5","Dp>1.0","Dp>2.5","Dp>5.0","Dp>10.0",
...
void sdPrint(DateTime now_time, float temp, float humidity, char pmData[], float batLevel, std::pair<float, float> ccsRead) {
    ...
    sprintf(data, "%10s,%10s,%10s,%10s,%10s,%10s,%5s,%10s,%10s", counter_str, dateData, timeData, batData, pmData, tempData, rhData, co2Data, tvocData);
    if(sdCardInserted()) {
